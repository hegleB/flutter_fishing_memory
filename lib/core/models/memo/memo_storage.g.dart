...
part of 'memo_storage.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

_$MemoStorageImpl _$$MemoStorageImplFromJson(Map<String, dynamic> json) =>
    _$MemoStorageImpl(
...
Map<String, dynamic> _$$MemoStorageImplToJson(_$MemoStorageImpl instance) =>
    <String, dynamic>{
      'name': instance.name,
